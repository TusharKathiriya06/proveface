...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.lengdev.livenessdetector.LivenessDetectorPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin face_anti_spoofing_detector, com.lengdev.livenessdetector.LivenessDetectorPlugin", e);
    }
    try {
